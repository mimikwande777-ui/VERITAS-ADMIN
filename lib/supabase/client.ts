import { getBrowserClient, getBrowserDiagnostic, createSupabaseBrowserClient } from './browser';
import type { SupabaseClient } from '@supabase/supabase-js';

export { getBrowserClient, getBrowserDiagnostic, createSupabaseBrowserClient };
...
export function getBrowserSupabaseClientDiagnostic(): {
  ...
  return {
    hasPublicSupabaseUrl: diag.hasPublicUrl,
    hasPublicAnonKey: diag.hasPublicAnonKey,
    browserClientCreated: diag.browserClientCreated,
    ...(hostname ? { hostname } : {}),
  };
}
